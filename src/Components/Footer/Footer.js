    ...
    <div className={style.footer}>
      <div className={style.container}>
        <div className={style.wrapper}>
          <section className={`${style.items} ${style.topItem}`}>
            <h2 className={style.contacts}>Contacts</h2>
            <article>
              <p className={style.text}>2019 Rootz Foundation. All rights reserved</p>
            
            </article>
          </section>
          <section className={`${style.items} ${style.headquarters}`}>
            <h2 className={style.title}>Headquarters</h2>
            <article>
              <p className={style.text}>1234 Taliban<br/>Los Angeles, La 1234567<br/>(123) 456-7890</p>
             
            </article>
          </section>
          <section className={`${style.items} ${style.socialMedia}`}>
